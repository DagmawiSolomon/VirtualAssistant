...
__all__ = [
    ...
    'DISPID_SPIRetainedSizeBytes', 'SP_VISEME_4', 'DISPID_SVRate',
    'DISPID_SPRs_NewEnum', 'SpStream', 'DISPID_SWFESamplesPerSec',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRRPhraseInfo',
    'SAFT48kHz16BitMono', 'SPCT_SLEEP',
    'SpeechStreamSeekPositionType', 'SVP_10',
    'SpeechTokenKeyAttributes', 'eLEXTYPE_PRIVATE7',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SOTDataKey',
    'DISPID_SpeechRecoResultTimes', 'SpeechTokenValueCLSID',
    'SECFIgnoreKanaType', 'DISPID_SpeechLexiconPronunciation',
    'SRAImport', 'DISPID_SVEventInterests', 'SpSharedRecognizer',
    'SRTAutopause', 'SGRSTTWord', 'SPSEMANTICERRORINFO',
    'DISPID_SLPsCount', 'SPPHRASERULE', 'SPEI_RESERVED1',
    'SP_VISEME_6', 'SGLexical', 'DISPID_SpeechRecognizer',
    'SDA_One_Trailing_Space', 'DISPID_SVSPhonemeId',
    'eLEXTYPE_PRIVATE11', 'Speech_Max_Pron_Length', 'SVSFParseMask',
    'SAFTGSM610_8kHzMono', 'SPDKL_DefaultLocation', 'SPGS_ENABLED',
    'SpeechWordPronounceable', 'DISPID_SPIEnginePrivateData',
    'DISPID_SABufferNotifySize', 'SPWT_PRONUNCIATION',
    'DISPID_SRRDiscardResultInfo', 'IEnumString',
    'DISPID_SRCERequestUI', 'SpFileStream', 'SPSTREAMFORMATTYPE',
    'SpeechGrammarTagUnlimitedDictation', 'SVP_7',
    'eLEXTYPE_PRIVATE16', 'DISPID_SpeechGrammarRuleStateTransition',
    'SAFT48kHz16BitStereo', 'SVSFlagsAsync', 'DISPID_SGRSRule',
    'eLEXTYPE_PRIVATE3', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPWF_INPUT', 'SpeechSpecialTransitionType', 'SVP_12',
    'SSFMCreate', 'DISPID_SVSLastBookmarkId',
    'SAFTCCITT_uLaw_11kHzMono', 'SBONone', 'SITooQuiet',
    'SPSHORTCUTTYPE', 'eLEXTYPE_PRIVATE10', 'SPPHRASE',
    'SpeechDictationTopicSpelling', 'DISPID_SPEsItem',
    'DISPID_SpeechPhraseProperties', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpeechGrammarRules', 'DISPID_SRGCmdSetRuleState',
    'SVSFPurgeBeforeSpeak', 'DISPID_SGRClear', 'DISPID_SBSSeek',
    'SPFM_NUM_MODES', 'SP_VISEME_9', 'DISPID_SpeechGrammarRules',
    'DISPID_SPPId', 'SVSFUnusedFlags', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechLexiconWords', 'DISPID_SOTMatchesAttributes',
    ...
    'DISPID_SpeechDataKey', 'ISpeechPhoneConverter', 'WAVEFORMATEX',
    'Speech_StreamPos_RealTime', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPACommit', 'SPWT_LEXICAL', 'DISPID_SpeechVoiceStatus',
    'SPWORDPRONUNCIATION', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRSAudioStatus', 'DISPID_SFSOpen',
    'SPSMF_SAPI_PROPERTIES', 'SP_VISEME_13',
    'DISPID_SPEEngineConfidence', 'SPINTERFERENCE_TOOLOUD',
    'SpeechRunState', 'SVSFParseSapi', 'SGDisplay',
    'SGPronounciation', 'SAFT8kHz16BitStereo', 'eLEXTYPE_PRIVATE1',
    'DISPID_SREmulateRecognition', 'SPGS_DISABLED',
    'ISpeechPhraseElements', 'DISPID_SPIStartTime',
    'SpeechEngineConfidence', 'DISPID_SRRTimes', 'SPEI_HYPOTHESIS',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SBSFormat',
    'SAFT32kHz16BitMono', 'SpStreamFormatConverter',
    'DISPID_SVPriority', 'SAFTCCITT_uLaw_11kHzStereo', 'SPBO_PAUSE',
    'DISPID_SRGSetTextSelection', 'DISPID_SGRsCount',
    'SAFT22kHz16BitStereo', 'DISPID_SMSGetData',
    'DISPID_SPCIdToPhone', 'DISPID_SRCEStartStream',
    ...
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpeechObjectToken',
    'SpeechGrammarRuleStateTransitionType', 'SPSEMANTICFORMAT',
    'SSSPTRelativeToEnd', 'SpeechTokenIdUserLexicon',
    'SDKLCurrentConfig', 'SpNullPhoneConverter', 'ISpeechLexiconWord',
    'DISPID_SpeechAudioStatus', 'SASRun', 'SPEI_UNDEFINED',
    'DISPID_SOTCSetId', 'DISPID_SpeechFileStream', 'SPPROPERTYINFO',
    'SPEI_END_INPUT_STREAM', 'SpeechCategoryRecognizers',
    'DISPID_SRRRecoContext', 'DISPID_SVAlertBoundary',
    'DISPID_SGRsAdd', 'SGLexicalNoSpecialChars',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRRGetXMLResult',
    'DISPID_SRCEFalseRecognition', 'SP_VISEME_15',
    'DISPID_SLGenerationId', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SLPLangId', 'SPXRO_Alternates_SML',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SAFType',
    'DISPID_SVVoice', 'SpeechRuleAttributes', 'SVP_5', 'SPAR_Medium',
    'ISpeechAudioBufferInfo', 'DISPID_SRCAudioInInterferenceStatus',
    'SVSFNLPMask', 'SLODynamic', 'DISPID_SRGDictationSetState',
    'SGRSTTRule', 'SpMemoryStream', 'DISPID_SADefaultFormat',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SVEViseme', 'SPAR_Unknown',
    'SPSHT_Unknown', 'SVESentenceBoundary', 'SPGRAMMARSTATE',
    'SPSInterjection', 'ISpRecoContext', 'DISPID_SWFEExtraData',
    'SpeechAudioVolume', 'DISPID_SPPName',
    'DISPID_SpeechGrammarRuleState', 'SPRST_NUM_STATES',
    'SP_VISEME_19', 'SpeechRecoProfileProperties',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechVoiceCategoryTTSRate',
    'SAFT12kHz8BitMono', 'ISpeechPhraseElement', 'DISPID_SOTCDefault',
    'eLEXTYPE_RESERVED10', 'SPFM_CREATE_ALWAYS', 'SREAdaptation',
    'SpWaveFormatEx', 'eLEXTYPE_PRIVATE2', 'SRERecognition',
    'DISPID_SPERequiredConfidence', 'SpeechAddRemoveWord',
    '_SPAUDIOSTATE', 'SAFT16kHz16BitStereo',
    'SGDSActiveUserDelimited', 'DISPID_SpeechLexiconProns',
    'SDTLexicalForm', 'STCLocalServer', 'SAFTExtendedAudioFormat',
    'ISpRecognizer', 'SPSNoun', 'DISPID_SGRsDynamic',
    'DISPID_SPAStartElementInResult', 'SPRECOSTATE',
    'DISPID_SVAudioOutputStream', 'SPVPRI_OVER', 'SPSFunction',
    'DISPID_SpeechRecognizerStatus', 'SPLOADOPTIONS',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRGCmdSetRuleIdState',
    'SPEI_SOUND_END', 'DISPID_SpeechAudio', 'SDTProperty',
    'ISpRecoGrammar', 'DISPID_SGRSTsCount', 'DISPID_SOTCId',
    'SAFTADPCM_11kHzStereo', 'ISpNotifyTranslator', 'SPSMF_UPS',
    'ISpStreamFormat', 'DISPID_SVEBookmark', 'SPDKL_CurrentConfig',
    'DISPID_SPPsItem', 'ISpeechAudioStatus', 'DISPID_SLPPhoneIds',
    'SPRECOCONTEXTSTATUS', 'SRERequestUI', 'DISPID_SPRText',
    'DISPID_SGRSTText', 'ISpeechXMLRecoResult',
    'DISPID_SOTRemoveStorageFileName', 'SpeechWordType',
    'SpeechAudioFormatGUIDText', 'DISPID_SRCBookmark',
    'SpPhraseInfoBuilder', 'SASPause', 'DISPID_SGRsFindRule',
    'DISPID_SDKGetStringValue', 'SPEI_SOUND_START', 'DISPID_SVStatus',
    'ISpeechResourceLoader', 'SWTDeleted', 'SPEI_MAX_SR',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRCESoundEnd',
    'ISpeechRecoResultTimes', 'SAFT22kHz8BitMono', 'SpeechFormatType',
    'SVSFVoiceMask', 'DISPID_SOTIsUISupported',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPIRule',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPRulesCount',
    'SPDKL_LocalMachine', 'DISPID_SpeechLexicon',
    'SpeechVoiceSkipTypeSentence', 'ISpRecoResult',
    'SAFTCCITT_uLaw_44kHzStereo', 'SAFT44kHz16BitMono',
    'DISPID_SGRSAddRuleTransition', 'SPCT_COMMAND', 'SDTReplacement',
    'SAFT48kHz8BitMono', 'DISPID_SRRSpeakAudio', 'SPEI_WORD_BOUNDARY',
    'ISpSerializeState', 'DISPID_SPPEngineConfidence',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPIReplacements', 'SDTAll', 'ISpStreamFormatConverter',
    'DISPIDSPRG', 'DISPID_SPPFirstElement', 'DISPID_SPILanguageId',
    'SpeechEmulationCompareFlags', 'SRSActiveAlways',
    'SPRST_INACTIVE_WITH_PURGE', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SWTAdded', 'SPEI_PHONEME', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SLWLangId', 'DISPID_SPPParent', 'SpeechDataKeyLocation',
    'SAFTCCITT_ALaw_22kHzMono', 'SPVPRIORITY',
    'DISPID_SRCERecognizerStateChange', 'SAFT11kHz16BitStereo',
    'ISpeechLexiconWords', 'SDTDisplayText', 'SECFNoSpecialChars',
    'DISPID_SVGetVoices', 'DISPID_SRIsUISupported',
    'SPINTERFERENCE_NOSIGNAL', 'STCInprocHandler',
    'DISPID_SOTDisplayUI', 'SVEStartInputStream', 'SPPS_RESERVED4',
    'DISPID_SRCSetAdaptationData', 'SPEI_RESERVED2',
    'SPSSuppressWord', 'ISpObjectTokenCategory', 'DISPID_SRStatus',
    'SVEEndInputStream', 'DISPID_SRCPause', 'ISpeechPhraseInfo',
    'ISpStream', 'SPXMLRESULTOPTIONS', 'eLEXTYPE_RESERVED4',
    'eLEXTYPE_PRIVATE19', 'SDA_Consume_Leading_Spaces',
    'SpeechVoiceSpeakFlags', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpPhoneticAlphabetConverter', 'SVEAllEvents',
    'SPRECORESULTTIMES', 'ISpNotifySource', 'DISPID_SPEAudioSizeTime',
    'SAFT22kHz8BitStereo', 'SVP_18',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPRuleFirstElement', 'ISpeechBaseStream',
    'DISPID_SVSLastBookmark', 'eLEXTYPE_PRIVATE20',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRCEPropertyStringChange',
    'SPWT_DISPLAY', 'SPEI_MIN_TTS', 'SpeechAudioState',
    'DISPID_SRCEBookmark', 'DISPID_SpeechObjectToken',
    'DISPID_SVESentenceBoundary', 'SGRSTTDictation', 'SP_VISEME_20',
    'SPPS_Noncontent', 'SAFT32kHz8BitStereo',
    'DISPID_SPRuleConfidence', 'DISPID_SRCreateRecoContext',
    'ISpeechVoiceStatus', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPAPhraseInfo', 'SPAUDIOSTATUS', 'DISPID_SFSClose',
    ...
    'SPEI_TTS_PRIVATE', 'eLEXTYPE_PRIVATE5', 'IStream', 'SRSEDone',
    'SPAS_PAUSE', 'ISpDataKey', 'SPCONTEXTSTATE',
    'DISPID_SpeechObjectTokens', 'ISpeechRecoResultDispatch',
    'ISpeechCustomStream', 'SPLO_DYNAMIC',
    'DISPID_SpeechPhraseReplacements', 'SpMMAudioEnum',
    'DISPID_SVSInputWordLength', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SAEventHandle', 'DISPID_SVEWord', 'STSF_LocalAppData',
    'ISpeechObjectTokenCategory', 'DISPID_SVSkip',
    'SPEI_START_INPUT_STREAM', 'DISPID_SGRAddResource',
    'SpeechVoicePriority', 'SpeechGrammarTagDictation',
    'DISPID_SLWPronunciations', 'DISPID_SLGetGenerationChange',
    'eLEXTYPE_USER', 'ISpLexicon', 'SRTEmulated', 'SVEViseme',
    'ISpeechRecognizerStatus', 'SAFTCCITT_uLaw_22kHzStereo',
    'SDTAudio', 'eLEXTYPE_PRIVATE12', 'SPPHRASEPROPERTY',
    'DISPID_SRCEPropertyNumberChange', 'SPSHORTCUTPAIR',
    'SPWAVEFORMATTYPE', 'SVSFIsXML', 'SGSEnabled', 'ISpVoice',
    'ISpResourceManager', 'SVP_11', 'DISPID_SPRulesItem',
    'SWPKnownWordPronounceable', 'SAFTCCITT_uLaw_8kHzMono',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPRDisplayAttributes',
    'STSF_CommonAppData', 'DISPID_SLWsCount', 'SPRST_ACTIVE_ALWAYS',
    'SPEVENTSOURCEINFO', 'ISpeechMMSysAudio',
    'DISPID_SVGetAudioInputs', 'DISPID_SDKSetLongValue',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPPS_Interjection', 'DISPID_SPRuleName', 'SpeechAllElements',
    'SPFM_CREATE', 'DISPID_SRGReset', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRRAudioFormat', 'ISpeechDataKey', 'ISpeechObjectTokens',
    'SpeechGrammarState', 'SVEPhoneme', 'ISpeechPhraseAlternate',
    'DISPID_SRRSaveToMemory', 'ISequentialStream',
    'SPSHORTCUTPAIRLIST', 'SPINTERFERENCE_TOOFAST',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechCustomStream',
    'eLEXTYPE_PRIVATE13', 'SPCT_SUB_COMMAND', 'DISPID_SPPConfidence',
    'SP_VISEME_16', 'SPSERIALIZEDPHRASE', 'DISPID_SRGetFormat',
    'SAFT44kHz8BitStereo', 'DISPID_SVSLastResult', 'SPRS_INACTIVE',
    'SVPAlert', 'DISPID_SVEStreamEnd', 'SPBO_AHEAD',
    'DISPID_SWFEFormatTag', 'ISpeechGrammarRuleStateTransition',
    'SPTEXTSELECTIONINFO', 'ISpeechFileStream', 'SPWORD',
    'SP_VISEME_10', 'SGDSActiveWithAutoPause', 'SDTPronunciation',
    'SpeechCategoryAudioOut', 'SpeechMicTraining',
    'DISPID_SRCESoundStart', 'DISPID_SRState', 'DISPID_SGRId',
    'DISPID_SRRAudio', 'SSFMOpenForRead', 'DISPID_SPRules_NewEnum',
    'DISPID_SRCEInterference', 'SAFT8kHz8BitStereo', 'SRAExport',
    'SpeechTokenContext', 'SINoSignal', 'SINoise', 'SPAS_CLOSED',
    'SpInprocRecognizer', 'DISPID_SRRTTickCount',
    'ISpeechMemoryStream', 'SSFMCreateForWrite', 'SP_VISEME_17',
    'SpeechTokenKeyUI', 'SAFTCCITT_uLaw_44kHzMono', 'SpObjectToken',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SpeechRecoContext',
    'SpMMAudioOut', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SCSBaseStream', 'SpeechTokenKeyFiles',
    'DISPID_SVSpeakStream', 'DISPID_SGRSTransitions',
    'DISPID_SRCEEndStream', 'SPLO_STATIC', 'DISPID_SPCPhoneToId',
    'SPFILEMODE', 'DISPID_SRGCommit', 'SP_VISEME_0', 'ISpAudio',
    'DISPID_SVIsUISupported', 'DISPID_SGRInitialState', 'SFTSREngine',
    'SAFTNonStandardFormat', 'SPFM_OPEN_READONLY',
    'DISPID_SLRemovePronunciation', 'SAFT22kHz16BitMono',
    'SDTAlternates', 'DISPID_SRCEAudioLevel',
    'SpeechRegistryLocalMachineRoot', 'ISpeechPhraseRules',
    'SAFT11kHz8BitStereo', 'DISPID_SpeechPhraseElements', 'LONG_PTR',
    'SAFT16kHz8BitMono', 'SAFT8kHz8BitMono', 'SpeechLoadOption',
    'DISPID_SPIElements', 'SAFTADPCM_8kHzMono', 'eLEXTYPE_PRIVATE4',
    ...
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpRecoContext2', 'ISpRecognizer3',
    'SSFMOpenReadWrite', 'SpeechVisemeFeature', 'SPAS_STOP',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVF_Emphasis',
    'DISPID_SMSSetData', 'DISPID_SPCLangId',
    'DISPID_SRCCmdMaxAlternates', 'SRADefaultToActive', 'SP_VISEME_2',
    'DISPID_SPIGetText', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SGDSInactive', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPPs_NewEnum',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPEDisplayAttributes', 'SVP_21',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SpeechBaseStream', 'SP_VISEME_11', 'DISPID_SPPValue',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SLWType', 'SPGS_EXCLUSIVE',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SGRSAddSpecialTransition',
    'SpeechPropertyResourceUsage', 'SVPNormal',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SpeechAudioBufferInfo',
    'SPPS_LMA', 'DISPID_SRSCurrentStreamPosition',
    'eLEXTYPE_PRIVATE14', 'SPSLMA', 'ISpeechPhraseReplacements',
    'SpeechEngineProperties', 'DISPID_SMSALineId', 'SVP_20',
    'SRESoundEnd', 'DISPID_SOTs_NewEnum', 'IEnumSpObjectTokens',
    'DISPID_SPEsCount', 'SRCS_Disabled', 'DISPID_SRRAlternates',
    'SPAS_RUN', 'SDKLCurrentUser', 'ISpMMSysAudio',
    'SpeechPropertyAdaptationOn', 'SpCustomStream',
    'DISPID_SPAsCount', 'SPFM_OPEN_READWRITE', 'SPEI_RESERVED6',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPSHT_NotOverriden', 'SpMMAudioIn',
    'eLEXTYPE_RESERVED6', 'DISPID_SRRecognizer',
    'DISPID_SRGetRecognizers', 'SAFT48kHz8BitStereo',
    'ISpeechPhraseProperties', 'DISPID_SVResume', 'eWORDTYPE_DELETED',
    'ISpeechPhraseRule', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechPropertyResponseSpeed', 'IInternetSecurityManager',
    'DISPID_SRAudioInputStream', 'DISPID_SRGDictationUnload',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SDKEnumKeys',
    'DISPIDSPTSI_SelectionLength', 'SECFIgnoreWidth',
    'eLEXTYPE_RESERVED9', 'SPEI_VISEME', 'DISPID_SDKDeleteValue',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SVSLastStreamNumberQueued',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRCEventInterests',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SVEPhoneme',
    'DISPID_SRAudioInput', 'DISPID_SOTGetStorageFileName',
    'DISPID_SpeechVoiceEvent', 'SPVPRI_NORMAL', 'SVEVoiceChange',
    'SPCT_SUB_DICTATION', 'SP_VISEME_18', 'DISPID_SDKGetlongValue',
    'DISPID_SOTsItem', 'DISPID_SPPChildren', 'SpeechRecognizerState',
    'DISPID_SDKOpenKey', 'SPCS_DISABLED', 'SpeechAudioFormatGUIDWave',
    'SITooFast', 'DISPID_SRCCreateGrammar', 'SpPhoneConverter',
    'SP_VISEME_5', 'SVSFIsFilename', 'DISPID_SRGId',
    'SPINTERFERENCE_NONE', 'DISPID_SOTsCount',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPCATEGORYTYPE',
    'DISPID_SRIsShared', 'SpeechDisplayAttributes', 'SRATopLevel',
    'SP_VISEME_8', 'DISPID_SLAddPronunciation',
    'DISPID_SVEEnginePrivate', 'DISPID_SVVolume', 'SVF_Stressed',
    'SAFT32kHz8BitMono', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPRuleParent', 'DISPID_SpeechVoice',
    'Speech_StreamPos_Asap', 'SECFEmulateResult', 'SITooLoud',
    'DISPID_SRCState', 'SVP_0', 'ISpEventSource',
    'DISPID_SpeechMemoryStream', 'ISpeechGrammarRuleStateTransitions',
    'eLEXTYPE_PRIVATE15', 'ISpeechTextSelectionInformation',
    'SPSHT_OTHER', 'DISPID_SpeechMMSysAudio', 'SVSFIsNotXML',
    'ISpeechRecoGrammar', 'SREAudioLevel', 'SPEI_START_SR_STREAM',
    'SPEI_SR_AUDIO_LEVEL', 'SRAInterpreter',
    'DISPID_SDKGetBinaryValue', 'SREPropertyStringChange',
    'DISPID_SVDisplayUI', 'SPAUDIOSTATE', 'DISPID_SRDisplayUI',
    'DISPID_SPRsItem', 'SpSharedRecoContext',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRSetPropertyNumber',
    'DISPID_SOTRemove', 'DISPID_SRCERecognition',
    'SpeechUserTraining', 'eLEXTYPE_PRIVATE17',
    'DISPID_SWFEBlockAlign', 'SPPS_SuppressWord', 'SPSUnknown',
    'SAFTADPCM_44kHzStereo', 'SVSFNLPSpeakPunc', 'SpLexicon',
    'SPEI_INTERFERENCE', 'SAFT12kHz16BitMono',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPEDisplayText',
    ...
    'SPWORDLIST', 'SpeechCategoryVoices', 'DISPID_SABIBufferSize',
    'SLTUser', 'DISPID_SLWs_NewEnum', 'SPEI_MAX_TTS', 'SP_VISEME_14',
    'SAFTNoAssignedFormat', 'ISpeechPhraseReplacement',
    'SRTExtendableParse', 'DISPID_SpeechPhraseRule',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SGRsCommit', 'SREHypothesis', 'ISpGrammarBuilder',
    'DISPID_SRCEAdaptation', 'DISPID_SLPSymbolic', 'SPPS_Unknown',
    'SITooSlow', 'DISPID_SRCVoicePurgeEvent', 'ISpNotifySink',
    'ISpeechRecoResult', 'SGRSTTTextBuffer',
    'DISPID_SRGSetWordSequenceData', 'SVSFDefault',
    'SPPHRASEREPLACEMENT', 'SAFT11kHz16BitMono',
    'DISPID_SASNonBlockingIO', 'SAFTText', 'SPEI_SENTENCE_BOUNDARY',
    'SpInProcRecoContext', 'SPPHRASEELEMENT', 'SPDKL_CurrentUser',
    'SAFTCCITT_ALaw_8kHzMono', 'Speech_Max_Word_Length',
    'DISPID_SRGetPropertyString', 'SpeechRuleState',
    'DISPID_SRCEHypothesis', 'SpeechAudioFormatType',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVSInputWordPosition',
    'SSTTDictation', 'SP_VISEME_21', 'DISPID_SVGetProfiles',
    ...
    'SPGRAMMARWORDTYPE', 'DISPID_SWFEChannels',
    'DISPID_SRSClsidEngine', 'SRTSMLTimeout', 'SPPS_Noun',
    'SAFT24kHz16BitMono', 'DISPID_SPIGrammarId', 'STCAll',
    'SP_VISEME_7', 'ISpeechPhraseProperty',
    'IInternetSecurityMgrSite', 'DISPID_SRCVoice', 'SVP_9',
    'DISPID_SpeechGrammarRule', 'SGRSTTWildcard',
    'eLEXTYPE_MORPHOLOGY', 'SPBO_TIME_UNITS', 'ISpRecoGrammar2',
    'SRESoundStart', 'DISPID_SDKSetBinaryValue',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRRTStreamTime',
    'SRSEIsSpeaking', 'SRAONone', 'DISPID_SVEStreamStart',
    'SpeechCategoryAppLexicons', 'SAFT24kHz16BitStereo',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SAVolume', 'DISPID_SpeechPhraseRules', 'SPAR_Low',
    'tagSPTEXTSELECTIONINFO', 'eLEXTYPE_APP', 'STCInprocServer',
    'SAFT24kHz8BitMono', 'SVP_19', 'DISPID_SVGetAudioOutputs',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPPsCount',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRCRecognizer', 'SVF_None',
    'SPEI_PHRASE_START', 'SpeechLexiconType', 'SVP_15',
    'SPAO_RETAIN_AUDIO', 'SFTInput',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFTGSM610_11kHzMono', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPEPronunciation', 'SPCS_ENABLED', 'SVP_2',
    'DISPID_SPEAudioStreamOffset', 'SPVOICESTATUS', 'SECFDefault',
    'SVP_4', 'SAFT12kHz8BitStereo', 'DISPID_SPRsCount',
    'SAFTCCITT_ALaw_44kHzStereo', 'SGRSTTEpsilon', 'SPWORDTYPE',
    'DISPID_SPRuleId', '__MIDL_IWinTypes_0009', 'DISPID_SGRSTType',
    'SAFT12kHz16BitStereo', 'DISPID_SPIProperties',
    'ISpeechLexiconPronunciation', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_RESERVED7', 'SpeechInterference', 'SVSFPersistXML',
    'DISPID_SpeechPhraseInfo', 'SPINTERFERENCE_TOOSLOW',
    'SAFT32kHz16BitStereo', 'SPEVENT', 'SPSNotOverriden',
    'DISPID_SpeechPhraseBuilder', 'STSF_FlagCreate', 'SECFIgnoreCase',
    'SPBOOKMARKOPTIONS', 'SGSDisabled', 'SRADynamic',
    'DISPID_SLWsItem', 'DISPID_SASState', 'SPPS_RESERVED2',
    'SPAR_High', 'SpResourceManager',
    'SpeechPropertyComplexResponseSpeed', 'SECNormalConfidence',
    'SSTTWildcard', 'SPAUDIOBUFFERINFO', 'SpeechDiscardType',
    'DISPID_SPEActualConfidence', 'SP_VISEME_12',
    'DISPID_SVSRunningState', 'ISpRecoCategory', 'DISPID_SRRTLength',
    'DISPID_SLPsItem', 'tagSTATSTG', 'SPSERIALIZEDRESULT',
    'SREFalseRecognition', 'SVP_6', 'SPRECOGNIZERSTATUS',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SASFreeBufferSpace',
    'SREStateChange', 'DISPID_SMSADeviceId', 'ISpEventSink',
    'SRAORetainAudio', 'SPEI_TTS_BOOKMARK', 'ISpPhrase',
    'SSSPTRelativeToStart', 'DISPID_SPIEngineId',
    'SpeechRecoContextState', 'SRERecoOtherContext', 'SPRST_INACTIVE',
    'SpeechGrammarTagWildcard', 'SAFTADPCM_44kHzMono',
    'ISpeechLexicon', 'SASClosed', 'SpeechVoiceEvents',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPAs_NewEnum', 'SVPOver',
    'SpeechRecoEvents', 'SRSInactiveWithPurge', 'DISPID_SAStatus',
    'DISPID_SDKDeleteKey', 'DISPID_SVSVisemeId', 'ISpeechGrammarRule',
    'SREAllEvents', 'ISpRecognizer2', 'SAFTGSM610_22kHzMono',
    'SPRS_ACTIVE', 'SAFTADPCM_11kHzMono', 'SASStop', 'SpAudioFormat',
    'SPEI_SR_BOOKMARK', 'SGSExclusive', 'SREPrivate',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRCRequestedUIType',
    'DISPID_SOTGetAttribute', 'DISPID_SLPType', 'SVP_14',
    'SPPS_NotOverriden', 'DISPID_SVSInputSentencePosition', 'SLTApp',
    'SPPS_Modifier', 'SDKLLocalMachine', 'SPEI_RESERVED5',
    'SVEPrivate', 'SPSModifier', 'SpNotifyTranslator', 'SPSHT_EMAIL',
    'SVEWordBoundary', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechPhraseProperty', 'SRSActive',
    'DISPID_SOTCreateInstance', 'SpeechRetainedAudioOptions',
    'ISpeechAudioFormat', 'DISPID_SPIAudioSizeTime',
    'DISPID_SVEAudioLevel', 'eLEXTYPE_PRIVATE6', 'STSF_AppData',
    'STCRemoteServer', 'DISPID_SPARecoResult', 'SPEI_VOICE_CHANGE',
    'DISPID_SDKSetStringValue', 'ISpPhoneticAlphabetSelection',
    'SRTReSent', 'SPRST_ACTIVE', 'SpeechPartOfSpeech',
    'DISPID_SpeechRecoResult2', 'SRARoot', 'SPWORDPRONOUNCEABLE',
    'DISPID_SABufferInfo', 'SINone', 'DISPID_SGRSTWeight',
    'SPVPRI_ALERT', 'SPEI_REQUEST_UI', 'SLOStatic', 'SRTStandard',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRGRules',
    'ISpPhraseAlt', 'ISpProperties', 'SP_VISEME_1',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPEs_NewEnum',
    'DISPID_SVEVoiceChange', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SGRsCommitAndSave', 'SVP_13', 'SVEAudioLevel',
    '_ISpeechRecoContextEvents', 'DISPID_SOTId',
    'DISPID_SRCRetainedAudio', 'SpeechRecognitionType',
    'ISpeechRecoResult2', 'SAFTDefault', '_ISpeechVoiceEvents',
    'SAFT44kHz8BitMono', 'DISPID_SBSRead', 'SPPS_RESERVED3',
    'DISPID_SPELexicalForm', 'SPEI_SR_PRIVATE', 'SPEI_END_SR_STREAM',
    'SDTRule', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPIDSPTSI',
    'DISPID_SLWWord', 'SPPARTOFSPEECH', 'DISPID_SPISaveToMemory',
    'SPLEXICONTYPE', 'SREStreamEnd',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRGCmdLoadFromFile', 'SPPS_Verb', 'SAFT44kHz16BitStereo',
    'SSTTTextBuffer', 'SpVoice', 'SWPUnknownWordPronounceable',
    'SPEI_RECO_STATE_CHANGE', 'SPADAPTATIONRELEVANCE', 'SPRULESTATE',
    'DISPID_SVSCurrentStreamNumber', 'SPEVENTENUM',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SPRFirstElement',
    'UINT_PTR', 'SAFT11kHz8BitMono', 'DISPID_SOTGetDescription',
    'SDA_No_Trailing_Space', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SpeechLexiconWord', 'SVSFParseAutodetect',
    'DISPID_SPAsItem', 'DISPID_SASetState',
    'DISPID_SPIAudioSizeBytes', 'SAFT16kHz8BitStereo', 'SVP_16',
    '_RemotableHandle', 'SpeechCategoryPhoneConverters',
    ...
    'SPPS_RESERVED1', 'DISPID_SRProfile', 'SpeechAudioProperties',
    'DISPID_SRSetPropertyString', 'SPDATAKEYLOCATION',
    'DISPID_SDKCreateKey', 'SPAO_NONE', 'SPRULE', 'SVP_1',
    'SREBookmark', 'SREPropertyNumChange',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechAudioFormat',
    'SGDSActive', 'SRCS_Enabled', 'SAFTCCITT_ALaw_11kHzMono',
    'eLEXTYPE_RESERVED8', 'DISPID_SRRGetXMLErrorInfo', 'ISpeechAudio',
    ...
    'DISPID_SGRsItem', 'SPEI_MIN_SR', 'SpeechVisemeType',
    'SREPhraseStart', 'SpeechCategoryRecoProfiles', 'SPEI_RESERVED3',
    'DISPIDSPTSI_ActiveLength', 'SVEBookmark', 'ISpShortcut',
    'SpShortcut', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPPNumberOfElements', 'SpCompressedLexicon',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVSpeak',
    'DISPID_SRCEPhraseStart', 'DISPID_SGRAddState', 'SBOPause',
    'eWORDTYPE_ADDED', 'SREStreamStart', 'SpUnCompressedLexicon',
    'DISPID_SRCEEnginePrivate', 'eLEXTYPE_PRIVATE8', 'SPPS_Function',
    'ISpObjectToken', 'DISPID_SGRName', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SMSAMMHandle', 'SVP_3', 'ISpPhoneConverter',
    'DISPID_SGRSTsItem', 'SPXRO_SML', 'DISPID_SVWaitUntilDone',
    'DISPID_SRCResume', 'SVSFParseSsml', 'SVP_17', 'DISPID_SGRSTRule',
    'SPINTERFERENCE', 'SREInterference',
    ...
    'tagSPPROPERTYINFO', 'DISPID_SVPause', 'SVP_8',
    'DISPID_SDKEnumValues', 'SPEI_ADAPTATION',
    'SpeechGrammarWordType', 'DISPID_SAFGuid', 'SECHighConfidence',
    'SpObjectTokenCategory', 'SPSVerb',
    'DISPID_SRSNumberOfActiveRules', 'ISpeechGrammarRuleState',
    'DISPID_SVAudioOutput', 'DISPID_SABIEventBias',
    'SAFT8kHz16BitMono', 'DISPID_SLGetWords', 'SPCT_DICTATION',
    'ISpeechRecognizer', 'SpeechStreamFileMode', 'SRSInactive',
    'ISpeechVoice', 'SAFT24kHz8BitStereo', 'DISPID_SGRSTNextState',
    'SpeechBookmarkOptions', 'DISPID_SRGDictationLoad',
    'ISpeechPhraseAlternates', 'SAFTADPCM_22kHzMono',
    'DISPID_SGRSTPropertyName'
]

_check_version('1.2.0', 1618052613.322049)
